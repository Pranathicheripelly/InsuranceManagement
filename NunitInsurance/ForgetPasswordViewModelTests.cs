...
namespace NunitInsurance
{
    ...
    public class ForgetPasswordViewModelTests
    {
        ...
        public void Valid_Model()
        {
            ...
            // Act & Assert
            //using NUnit, that the execution of the ValidateModel method with the viewModel parameter does not
            //throw any exceptions. If an exception is thrown, the test would fail.
